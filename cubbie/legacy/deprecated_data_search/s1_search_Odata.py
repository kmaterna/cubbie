...
def SentinelHub_query(args):
    ...
    if args['orbit_direction'] == 'Ascending':
        filter_str = " and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'orbitDirection' and att/OData.CSC.StringAttribute/Value eq 'ASCENDING')"
    elif args['orbit_direction'] == 'Descending':
        filter_str = " and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'orbitDirection' and att/OData.CSC.StringAttribute/Value eq 'DESCENDING')"
    ...
    # Searching for point
        ...
        results = session.get(
            ...
            "ContentDate/Start gt "+str(time_interval[0])+"T00:00:00.000Z and "
            "ContentDate/Start lt "+str(time_interval[1])+"T00:00:00.000Z and "
            "OData.CSC.Intersects(area=geography'SRID=4326;POINT("+str(args['coordinate'][0])+" "+str(args['coordinate'][1])+")')" +
            filter_str +
            "&$top=1000"
        ).json()
