...
ls -d DATA/S*/ > $acq_timing
cut -c23-30 $acq_timing > temp_timing.txt  # finding the timing of the acquisitions. 
rm $acq_timing
...
region="2014-10-01T00:00/2019-09-30T00:00/0.1/1"  # The beginning and end of Sentinel. 
