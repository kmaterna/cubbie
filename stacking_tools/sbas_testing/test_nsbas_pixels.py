...
import sbas_testing.io_functions
import nsbas
...
def test_single_pixel_nsbas():
    ...
    Igrams = sbas_testing.io_functions.read_testing_pixel(ifile, coherence=True);
    Igrams = sbas_testing.io_functions.take_coherent_igrams(Igrams, 0.375)
