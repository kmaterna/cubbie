...
def compute(gps_los_velfield, xarray, yarray, LOS_array):
	insar_array, gps_array = los_projection_tools.paired_gps_geocoded_insar(gps_los_velfield, xarray, yarray, LOS_array, window_pixels=15);
