...
def write_local_iscestack_config(source_file, target_file, date_string, alt_unwrapping=0, rlks=None, alks=None, filt=None):
...
def alt_isce_unwrapping_workflow(date_string):
	...
	axarr=add_plot(axarr, 2, slc_cut, 'phasefilt_cut', colormap='rainbow', aspect=plot_aspect, is_complex=1, vmin=-np.pi, vmax=np.pi);
	axarr=add_plot(axarr, 3, unw_cut, 'unwrapped', colormap='rainbow', aspect=plot_aspect, is_complex=0, vmin=0, vmax=unw_max);
	axarr=add_plot(axarr, 4, comps_cut, 'Connected Components', colormap='rainbow', aspect=plot_aspect, is_complex=0, vmin=0, vmax=8);
	...
	isce_read_write.write_isce_data(interp_array, nx, ny, dtype='CFLOAT', filename=alt_filedir+filestem+"_manually_masked.int");
	...
	axarr=add_plot(axarr, 7, post_unwrapping, 'Unwrapped', colormap='rainbow', aspect=plot_aspect, is_complex=0, vmin=0, vmax=unw_max);
