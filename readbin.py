...
if __name__=="__main__":
	...
	filename="2015225_2015249/out.int"; length=1524; width=661;
	[real,imag]=read_binary_roipac_real_imag(filename, width);
	[phase,amp]=real_imag2phase_amp(real,imag);
	outputs(phase, amp, width, length, '2015225_2015249/working_example.eps');

	filename="2015225_2015249/out_filtered.int"; length=1524; width=661;
	[real,imag]=read_binary_roipac_real_imag(filename, width);
	[phase,amp]=real_imag2phase_amp(real,imag);
	outputs(phase, amp, width, length, '2015225_2015249/working_example_filt.eps');
